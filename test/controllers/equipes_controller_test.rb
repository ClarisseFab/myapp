...
class EquipesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create equipe" do
    assert_difference("Equipe.count") do
      post equipes_url, params: { equipe: { nom_capitaine: @equipe.nom_capitaine, nom_equipe: @equipe.nom_equipe, string: @equipe.string, telephone: @equipe.telephone } }
    end
  ...
  test "should update equipe" do
    patch equipe_url(@equipe), params: { equipe: { nom_capitaine: @equipe.nom_capitaine, nom_equipe: @equipe.nom_equipe, string: @equipe.string, telephone: @equipe.telephone } }
